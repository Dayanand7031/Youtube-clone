    ...
    <div>
       <Link to={`/video/${video?.videoId}`}>
                <div className='flex flex-col md:flex-row mb-8 md:mb-3 md:p-4 '>
                    {/*thumbnail*/}
                    <div className="relative fl h-48 w-full md:w-80  md:h-56 md:rounded-xl hover:rounded-none duration-200 overflow-hidden">
                        <img className='h-full w-full rounded-lg object-cover' src={video?.thumbnails[0]?.url} alt='' />
